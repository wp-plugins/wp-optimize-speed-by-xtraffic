...
Tags:  optimize, image, images, cache, javascript, css, stylesheet, style, minify, combine, speed, performance, images lazy load, lazy load
Requires at least: 2.3
Tested up to: 4.2.2
Stable tag: trunk

Plugin "WP Optimize Speed By xTraffic" speed up your WordPress website, save resources and bandwidth of server, increase website's Google PageSpeed Insights point.
...
* ***Optimize Speed*** : make page speed load amazingly fast by these features "Optimize Javascript + Optimize CSS (Style) + Optimize HTML"
  * Optimize Cache : Make your WordPress website load faster from 80% or more. Prebuild cache the most visited pages. This feature compatible with WooCommerce.
    * Database Cache : Support APC + Memcache + File
  * Optimize Javascript :
    * Combine Javascript
    * Minify Javascript
